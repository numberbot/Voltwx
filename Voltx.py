...
# ==================== কনফিগারেশন ====================
TELEGRAM_TOKEN = "8649024139:AAHy2i3jQJmQfyB7aq3wk_2917M7D6B8iVI"
ADMIN_ID = 7787612625
...
def handle_callback(call):
    ...
    if data.startswith("get_number_"):
        ...
        loading_msg = bot.send_message(chat_id, f"⏳ Requesting 2 numbers from `{range_code}`...", parse_mode="Markdown")
        
        numbers_found = []
        for i in range(2):  # ২টি নাম্বার নেওয়া হবে
    ...
    if data.startswith("change_number_"):
        ...
        bot.delete_message(chat_id, msg_id)
        loading_msg = bot.send_message(chat_id, f"⏳ Requesting 2 new numbers...", parse_mode="Markdown")
...
if __name__ == "__main__":
    print("=" * 60)
    print("🤖 VOLTX OTP BOT - 2 NUMBERS VERSION")
    print("✅ 2 numbers will be fetched at once")
